...
4. Jalankan server Apache. Buka http://localhost/dinsosda.
...
Kontribusi sangat diterima! Baca [CONTRIBUTING](CONTRIBUTING.md) dan buka [Issues](https://github.com/Celieln/dinsosda/issues) untuk melaporkan bug / request fitur.
